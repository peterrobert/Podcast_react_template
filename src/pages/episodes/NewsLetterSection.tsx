const NewsLetterSection = () => {
  return (
    <section id="newsletter-cta" className="py-20">
          ...
          <div className="gradient-border">
            <div className="gradient-border-inner p-8 lg:p-12 text-center">
              ...
              <p className="text-slate-400 text-lg mb-8 max-w-2xl mx-auto">
                Get notified when new episodes drop, plus exclusive
                behind-the-scenes content and curated insights delivered to your
                inbox.
              </p>
